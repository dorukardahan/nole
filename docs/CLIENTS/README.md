...
| Hermes Agent | generic/unverified | generic MCP stdio template | Priority target, but no verified Hermes config test is recorded in this repo yet. Not installed on the recorded verification hosts. |
