...
// ComprehensiveFixtureSet extends the deterministic offline fixtures only for
// explicit comprehensive live runs. DefaultFixtureSet and its route evidence
// stay unchanged; the added public fixtures exercise option mapping and common
// rendered-fetch outcomes without storing provider payloads.
func ComprehensiveFixtureSet() FixtureSet {
	base := DefaultFixtureSet()
	fixtures := append([]Fixture(nil), base.Fixtures...)
	fixtures = append(fixtures,
		Fixture{ID: "localized-search-tr", Task: core.TaskGeneral, Kind: KindSearch, Query: "Türkiye yapay zeka mevzuatı", Language: "tr", Category: "localized search options", Country: "tr", SearchLang: "tr"},
